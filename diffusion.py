...
if __name__ == "__main__":
    ...
    dataloader = setup_loader(
        data_dir="/zfs-pool/home/xbanak01/datasets/coco/train_imgs/resized_128",
        batch_size=batch_size,
        shuffle=True,
        transform=transform,
    )
    nr_batches = math.ceil(len(dataloader.dataset) / batch_size)
    model = Unet(
        dim=image_size,
        channels=channels,
        dim_mults=dim_mults,
    ...
    for epoch in tqdm(range(epochs), unit="epoch"):
        ...
        for step, batch in tqdm(enumerate(dataloader), unit="batch", unit_scale=True, total=nr_batches, leave=False):
            optimizer.zero_grad()
